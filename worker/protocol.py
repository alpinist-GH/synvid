...
REQUEST_KINDS = frozenset({"hello", "get_status", "list_outputs", "recovery_preview", "recover", "generate", "edit_video", "edit_image", "narrate", "export_video", "cancel", "unload_model"})
