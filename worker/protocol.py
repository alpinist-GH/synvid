...
REQUEST_KINDS = frozenset({"hello", "get_status", "model_catalog", "download_model", "remove_model", "clean_temporary", "list_outputs", "recovery_preview", "recover", "generate", "edit_video", "edit_image", "narrate", "export_video", "story_create", "story_list", "story_get", "story_update", "story_add_scene", "story_update_scene", "story_reorder_scenes", "story_draft_scenes", "story_record_artifact", "story_import_still", "story_import_subtitles", "story_import_narration", "story_import_clip", "story_export_project", "story_import_project", "render_story", "compose_story", "cancel", "unload_model"})
